...
if __name__ == "__main__":
    ...
    data_dir = 'motion_temp_data/joint'
    # change your save folder
    save_dir1 = 'motion_temp_data/new_joints/'
    # change your save folder
    save_dir2 = 'motion_temp_data/new_joint_vecs/'
    ...
    example_data = np.load('motion_data/joint/idea400/subset_0000/Blowing_A_Balloon_During_Walking.npy')
